...
namespace HR.LeaveManagement.Api.Controllers
{
    ...
    public class LeaveAllocationsController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post([FromBody] CreateLeaveAllocationCommand leaveAllocationCommand)
        {
        ...
        public async Task<ActionResult> Put([FromBody] UpdateLeaveAllocationCommand leaveAllocationCommand)
        {
